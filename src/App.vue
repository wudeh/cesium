<template>
  <div class="box">
    <img class="img" src="./assets/images/ray.gif" alt="">
...
<script setup >
    ...
    const initMap = async () => {
        ...
        // 设置相机飞到哪个经纬度
        viewer.camera.flyTo({
          destination: Cesium.Cartesian3.fromDegrees((fujianshiJson).features[0].properties.center[0], (fujianshiJson).features[0].properties.center[1], 1000000.0), // 设置位置
          orientation: {
