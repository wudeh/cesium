...
export default class CircleDiffusion {
  ...
  constructor(viewer) {
    ...
    this.originList = [];
    // js语法的每行结尾的“分号”可写可不写
    // this.viewer.scene.postRender.addEventListener(this.resetPosition, this);
  ...
  startPositonRender(){
    this.viewer.scene.camera.moveEnd.addEventListener((camera) => {
